...
> sandforge@1.2.4 knip C:\VSCODE\salesforce\SANDFORGE
...
| :------------------------ | :------------------------------------ | :------- |
| winston                   | packages/extension/package.json:309:6 | error    |
| glob                      | packages/extension/package.json:303:6 | error    |
| @radix-ui/react-accordion | packages/webview/package.json:25:6    | error    |
| @radix-ui/react-checkbox  | packages/webview/package.json:26:6    | error    |
| @radix-ui/react-popover   | packages/webview/package.json:28:6    | error    |
| @radix-ui/react-tooltip   | packages/webview/package.json:33:6    | error    |
| @radix-ui/react-select    | packages/webview/package.json:29:6    | error    |
| @radix-ui/react-slider    | packages/webview/package.json:30:6    | error    |
| @radix-ui/react-switch    | packages/webview/package.json:31:6    | error    |
| @tanstack/react-query     | packages/webview/package.json:35:6    | error    |
| @tanstack/react-table     | packages/webview/package.json:36:6    | error    |
| @monaco-editor/react      | packages/webview/package.json:24:6    | error    |
| @hookform/resolvers       | packages/webview/package.json:23:6    | error    |
| react-hook-form           | packages/webview/package.json:48:6    | error    |
| zod                       | packages/webview/package.json:53:6    | error    |
| d3                        | packages/webview/package.json:40:6    | error    |

## Unused devDependencies (13)

| Name                             | Location                              | Severity |
| :------------------------------- | :------------------------------------ | :------- |
| @typescript-eslint/eslint-plugin | packages/extension/package.json:316:6 | error    |
| @typescript-eslint/parser        | packages/extension/package.json:317:6 | error    |
| eslint-config-prettier           | packages/extension/package.json:322:6 | error    |
| @vscode/vsce                     | packages/extension/package.json:319:6 | error    |
| @typescript-eslint/eslint-plugin | packages/webview/package.json:66:6    | error    |
| @typescript-eslint/parser        | packages/webview/package.json:67:6    | error    |
| eslint-config-prettier           | packages/webview/package.json:72:6    | error    |
| @axe-core/playwright             | packages/webview/package.json:57:6    | error    |
...
| Name                          | Location                                                                   | Severity |
| :---------------------------- | :------------------------------------------------------------------------- | :------- |
| DiamondMarkerDef              | packages/webview/src/pages/Autopilot/AutopilotGraph/RelationEdge.tsx:22:14 | error    |
| AI_ANALYSIS_TYPES             | packages/extension/src/bridge/handlers/ai/AIAnalysisHandler.ts:14:14       | error    |
| ComplianceTimeline            | packages/webview/src/pages/Autopilot/ComplianceReport/index.ts:2:10        | error    |
| Step3Compliance               | packages/webview/src/pages/Autopilot/AutopilotWizard/index.ts:7:10         | error    |
| Step1Connect                  | packages/webview/src/pages/Autopilot/AutopilotWizard/index.ts:3:10         | error    |
| Step2Objects                  | packages/webview/src/pages/Autopilot/AutopilotWizard/index.ts:5:10         | error    |
| Step4Review                   | packages/webview/src/pages/Autopilot/AutopilotWizard/index.ts:9:10         | error    |
| DiamondMarkerDef              | packages/webview/src/pages/Autopilot/AutopilotGraph/index.ts:3:24          | error    |
| AI_TOOLS_TYPES                | packages/extension/src/bridge/handlers/ai/AIToolsHandler.ts:14:14          | error    |
| GraphControls                 | packages/webview/src/pages/Autopilot/AutopilotGraph/index.ts:6:10          | error    |
| RelationEdge                  | packages/webview/src/pages/Autopilot/AutopilotGraph/index.ts:3:10          | error    |
| GraphLegend                   | packages/webview/src/pages/Autopilot/AutopilotGraph/index.ts:5:10          | error    |
| ObjectNode                    | packages/webview/src/pages/Autopilot/AutopilotGraph/index.ts:1:10          | error    |
| GovernanceRuleConditionSchema | packages/extension/src/modules/monitor/GovernanceEngine.ts:11:14           | error    |
| AI_CHAT_TYPES                 | packages/extension/src/bridge/handlers/ai/AIChatHandler.ts:42:14           | error    |
| AnonymizationPreview          | packages/webview/src/pages/Autopilot/ControlPanel/index.ts:4:10            | error    |
| ComplianceStatus              | packages/webview/src/pages/Autopilot/ControlPanel/index.ts:5:10            | error    |
| NodeDetail                    | packages/webview/src/pages/Autopilot/ControlPanel/index.ts:3:10            | error    |
| LiveStats                     | packages/webview/src/pages/Autopilot/ControlPanel/index.ts:2:10            | error    |
| TeamConfigBundleSchema        | packages/extension/src/core/config/TeamConfigService.ts:7:14               | error    |
| AuditEntrySchema              | packages/extension/src/core/audit/AuditTrailService.ts:31:14               | error    |
| selectConnectedOrgs           | packages/webview/src/stores/useOrgStore.ts:72:14                           | error    |

## Unused exported types (473)
...
| Step4ReviewProps             | packages/webview/src/pages/Autopilot/AutopilotWizard/index.ts:10:15              | error    |
...
| Step3ComplianceProps         | packages/webview/src/pages/Autopilot/AutopilotWizard/index.ts:8:15               | error    |
...
| Step1ConnectProps            | packages/webview/src/pages/Autopilot/AutopilotWizard/index.ts:4:15               | error    |
| Step2ObjectsProps            | packages/webview/src/pages/Autopilot/AutopilotWizard/index.ts:6:15               | error    |
...
| RelationEdgeData             | packages/webview/src/pages/Autopilot/AutopilotGraph/index.ts:4:15                | error    |
| ObjectNodeData               | packages/webview/src/pages/Autopilot/AutopilotGraph/index.ts:2:15                | error    |
