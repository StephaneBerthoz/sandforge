...
| Account | ✗ 0/3 (`__pc`/`Name` errors) | ✓ 1/3 (Business Account succeeds; Person Account `Name` errors gone — remaining 2 fail on locale-restricted picklists, a REDACTED-CLIENT-specific schema constraint) |
...
- 2nd attempt after fixes: **52/58 ✓ inserted on SBER** — Case (1/1),
  Contact (50/50), Example_Object_2__c (1/1). 6 remaining failures fall into
