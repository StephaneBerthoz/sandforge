...
export const FORGE_ANONYMIZATION_PRESETS: readonly ForgeAnonymizationPreset[] = Object.freeze([
  ...
  },
  {
    ...
    name: 'Healthcare — PHI',
    description:
      'Anonymize PHI fields on insurance and patient-related custom objects (Numero_Assurance__c, Numero_Assistance__c, Birthdate__c, ...). Use on Mutuaide-style health-services orgs.',
    rules: [
      {
        objectApiName: 'Contact',
      ...
      {
        objectApiName: 'Asset',
        fieldNames: ['Numero_Assurance__c', 'Numero_Assistance__c', 'Address'],
      },
      {
        objectApiName: 'InsurancePolicy',
        fieldNames: ['Numero_Assurance__c', 'Numero_Assistance__c'],
      },
      {
        objectApiName: 'CaseFileContact__c',
        fieldNames: ['Email__c', 'Phone__c', 'Birthdate__c', 'Address__c', 'DriverLicenseDate__c'],
      },
    ],
  },
  {
