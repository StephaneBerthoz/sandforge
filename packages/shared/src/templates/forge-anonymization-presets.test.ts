...
describe('FORGE_ANONYMIZATION_PRESETS', () => {
  ...
  it('healthcare preset includes Mutuaide-style PHI fields', () => {
    ...
    expect(asset?.fieldNames).toContain('Numero_Assurance__c');
    expect(asset?.fieldNames).toContain('Numero_Assistance__c');
  });
