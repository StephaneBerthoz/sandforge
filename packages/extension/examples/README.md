...
Expected output (Mutuaide UAT2 → MUT-SBER, fresh Case 00001120):
...
InsurancePolicy 1/1 ✓
GlobalContext__c 1/1 ✓
CoverageContext__c 1/1 ✓
CaseFileContact__c 1/5 ⚠ (4 hit a custom required field — see error panel)
...
3. Record ID: 0015I00000J0Np4QAF
...
pnpm tsx packages/extension/cli/sandforge-cleanup.ts \
  --target MUT-SBER --since today

# Step 2 — re-clone
pnpm tsx packages/extension/cli/sandforge-clone.ts \
  --record 500AP00000fXeQsYAK \
  --source MUT-UAT2 --target MUT-SBER
```
