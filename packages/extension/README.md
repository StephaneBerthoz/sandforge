...
[![Version](https://img.shields.io/badge/version-1.33.0-blue)](https://marketplace.visualstudio.com/items?itemName=StephaneBerthoz.sandforge)
...
| [DataOps](https://github.com/StephaneBerthoz/sandforge/blob/master/docs/modules/dataops.md)                               | Backup, restore, anonymization and a data-quality scan (compliance coming soon)                                   |
| [Automation](https://github.com/StephaneBerthoz/sandforge/blob/master/docs/modules/automation.md)                         | Visual pipeline builder: backups, comparisons, checks, notifications (scheduling and triggers coming soon)        |
