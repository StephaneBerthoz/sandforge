  ...
  Account: {
    ...
    rules: [
      ...
      },
      {
        fieldApiName: 'Phone',
        ruleType: 'mask',
        description: 'Mask phone keeping last 4 digits',
        recommended: true,
      },
      {
        fieldApiName: 'Fax',
        ruleType: 'nullify',
        description: 'Clear fax number',
        recommended: false,
      },
      {
      ...
      {
        fieldApiName: 'ShippingStreet',
        ruleType: 'fake',
        description: 'Replace with fake street address',
        recommended: false,
      },
      {
        fieldApiName: 'ShippingCity',
        ruleType: 'fake',
        description: 'Replace with fake city',
        recommended: false,
      },
      {
        fieldApiName: 'ShippingPostalCode',
        ruleType: 'mask',
        description: 'Mask postal code',
        recommended: false,
      },
      {
        ...
        ruleType: 'constant',
        description: 'Replace with placeholder text',
        recommended: false,
      },
      {
        fieldApiName: 'AnnualRevenue',
        ruleType: 'shuffle',
        description: 'Shuffle values across records',
        recommended: false,
      },
    ],
  },
  Contact: {
    ...
    rules: [
      ...
      },
      {
        ...
        ruleType: 'mask',
        description: 'Mask mobile phone',
        recommended: true,
      },
      {
        fieldApiName: 'HomePhone',
        ruleType: 'nullify',
        description: 'Clear home phone',
        recommended: false,
      },
      {
        fieldApiName: 'OtherPhone',
        ruleType: 'nullify',
        description: 'Clear other phone',
        recommended: false,
      },
      {
        fieldApiName: 'MailingStreet',
        ruleType: 'fake',
        description: 'Replace with fake street address',
        recommended: true,
      },
      {
        fieldApiName: 'MailingCity',
        ruleType: 'fake',
        description: 'Replace with fake city',
        recommended: true,
      },
      ...
      },
      {
        ...
        ruleType: 'nullify',
        description: 'Clear date of birth',
        recommended: true,
      },
      {
        fieldApiName: 'Title',
        ruleType: 'fake',
        description: 'Replace with fake job title',
        recommended: false,
      },
      {
        fieldApiName: 'Description',
    ...
    rules: [
      {
        fieldApiName: 'Name',
        ruleType: 'fake',
        description: 'Replace with fake opportunity name',
        recommended: true,
      },
      {
        fieldApiName: 'Amount',
        ruleType: 'shuffle',
        description: 'Shuffle amounts across records',
        recommended: true,
      },
      {
        fieldApiName: 'Description',
    ...
    rules: [
      {
        ...
        ruleType: 'fake',
        description: 'Replace with fake subject',
        recommended: true,
      },
      {
        fieldApiName: 'Description',
      ...
      {
        fieldApiName: 'SuppliedName',
        ruleType: 'fake',
        description: 'Replace with fake name',
        recommended: true,
      },
      {
        fieldApiName: 'SuppliedEmail',
        ruleType: 'fake',
        description: 'Replace with fake email',
        recommended: true,
      },
      {
        fieldApiName: 'SuppliedPhone',
        ruleType: 'mask',
        description: 'Mask phone number',
        recommended: true,
      },
      {
        fieldApiName: 'SuppliedCompany',
        ruleType: 'fake',
        description: 'Replace with fake company',
        recommended: false,
      },
    ],
  },
  User: {
    ...
    rules: [
      ...
      },
      {
        fieldApiName: 'Street',
        ruleType: 'nullify',
        description: 'Clear street address',
        recommended: false,
      },
