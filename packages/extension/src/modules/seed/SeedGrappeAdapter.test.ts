...
describe('SeedGrappeAdapter', () => {
  ...
  describe('partition', () => {
    ...
    it('should set dependencies from reference fields', () => {
      ...
      const partitions = adapter.partition(template);
      const contactPartitions = partitions.filter((p) =>
        p.records[0]?.startsWith('Contact:')
      );
  ...
  describe('aggregateResults', () => {
    it('should aggregate success counts', () => {
      const results: GrappeResult[] = [
        { grappeId: 'g1', status: 'success', processedRecords: 100, successCount: 100, failureCount: 0, errors: [], duration: 500 },
        { grappeId: 'g2', status: 'success', processedRecords: 50, successCount: 50, failureCount: 0, errors: [], duration: 300 },
      ];
    ...
    it('should count completed and failed partitions', () => {
      const results: GrappeResult[] = [
        { grappeId: 'g1', status: 'success', processedRecords: 100, successCount: 100, failureCount: 0, errors: [], duration: 500 },
        { grappeId: 'g2', status: 'failure', processedRecords: 50, successCount: 0, failureCount: 50, errors: ['Error'], duration: 200 },
      ];
    ...
    it('should use max duration across partitions', () => {
      const results: GrappeResult[] = [
        { grappeId: 'g1', status: 'success', processedRecords: 100, successCount: 100, failureCount: 0, errors: [], duration: 1000 },
        { grappeId: 'g2', status: 'success', processedRecords: 50, successCount: 50, failureCount: 0, errors: [], duration: 500 },
      ];
    ...
    it('should include all partition results', () => {
      const results: GrappeResult[] = [
        { grappeId: 'g1', status: 'success', processedRecords: 50, successCount: 50, failureCount: 0, errors: [], duration: 100 },
      ];
    ...
    it('should count partial status as completed', () => {
      const results: GrappeResult[] = [
        { grappeId: 'g1', status: 'partial', processedRecords: 100, successCount: 80, failureCount: 20, errors: [], duration: 500 },
      ];
