...
export const LOCALE_DATA: Record<SupportedLocale, LocaleDataSet> = {
  ...
  fr_FR: {
    firstNames: [
      'Marie', 'Pierre', 'Jean', 'Sophie', 'Nicolas',
      'Camille', 'Julien', 'Lea', 'Thomas', 'Emma',
      'Lucas', 'Chloe', 'Hugo', 'Manon', 'Antoine',
    ] as const,
    lastNames: [
    ...
    companies: [
      'Total SA', 'Renault Group', 'Airbus France', 'BNP Paribas', 'Carrefour',
      'Sanofi', 'Orange SA', 'Danone', 'Michelin', 'Capgemini',
    ] as const,
  ...
  de_DE: {
    firstNames: [
      'Max', 'Anna', 'Lukas', 'Lena', 'Felix',
      'Marie', 'Paul', 'Sophia', 'Leon', 'Emma',
      'Jonas', 'Mia', 'Elias', 'Hannah', 'Ben',
    ] as const,
    lastNames: [
      'Mueller', 'Schmidt', 'Schneider', 'Fischer', 'Weber',
      'Meyer', 'Wagner', 'Becker', 'Schulz', 'Hoffmann',
      'Koch', 'Richter', 'Wolf', 'Schaefer', 'Bauer',
    ] as const,
    cities: [
    ...
    companies: [
      'Siemens AG', 'Volkswagen', 'BMW Group', 'Deutsche Bank', 'SAP SE',
      'Allianz', 'BASF', 'Bosch GmbH', 'Bayer AG', 'DHL Deutsche Post',
    ] as const,
  ...
  es_ES: {
    firstNames: [
      'Carlos', 'Maria', 'Alejandro', 'Carmen', 'Javier',
      'Lucia', 'Miguel', 'Marta', 'Daniel', 'Ana',
      'Pablo', 'Elena', 'Diego', 'Laura', 'Sergio',
    ] as const,
    lastNames: [
    ...
    cities: [
      ...
      'Malaga', 'Bilbao', 'Murcia', 'Palma', 'Granada',
    ] as const,
    companies: [
      'Telefonica', 'Inditex', 'Santander', 'BBVA', 'Repsol',
      'Iberdrola', 'CaixaBank', 'Endesa', 'Mapfre', 'Ferrovial',
    ] as const,
  ...
  ja_JP: {
    firstNames: [
      'Taro', 'Hanako', 'Yuki', 'Kenji', 'Sakura',
      'Haruto', 'Yui', 'Sota', 'Hina', 'Ren',
      'Mei', 'Kaito', 'Aoi', 'Riku', 'Mio',
    ] as const,
    lastNames: [
    ...
    companies: [
      'Toyota Motor', 'Sony Group', 'Honda Motor', 'Mitsubishi Corp', 'SoftBank',
      'Panasonic', 'Hitachi Ltd', 'NTT Data', 'Canon Inc', 'Fujitsu',
    ] as const,
  ...
  pt_BR: {
    firstNames: [
      'Joao', 'Ana', 'Pedro', 'Maria', 'Lucas',
      'Juliana', 'Gabriel', 'Fernanda', 'Rafael', 'Camila',
      'Matheus', 'Larissa', 'Bruno', 'Beatriz', 'Thiago',
    ] as const,
    lastNames: [
    ...
    companies: [
      'Petrobras', 'Vale SA', 'Itau Unibanco', 'Bradesco', 'Banco do Brasil',
      'Ambev', 'JBS SA', 'Magazine Luiza', 'Natura Co', 'Embraer',
    ] as const,
