  ...
  return (
    ...
    >
      ...
      >
        ...
        <g
          style={{
            transformOrigin: '195px 140px',
            animation: 'mojitoSway 3s ease-in-out infinite',
          }}
        >
          {/* Leaf 1 */}
        ...
        <circle
          ...
          style={{ animation: 'mojitoBubbleRise1 3s ease-in infinite' }}
        />
        <circle
          cx="200"
          cy="290"
          ...
          style={{ animation: 'mojitoBubbleRise2 3.5s ease-in infinite 0.5s' }}
        />
        <circle
          cx="215"
          cy="275"
          ...
          style={{ animation: 'mojitoBubbleRise3 4s ease-in infinite 1s' }}
        />
        <circle
          cx="190"
          cy="260"
          ...
          style={{ animation: 'mojitoBubbleRise4 3.2s ease-in infinite 1.5s' }}
        />
        <circle
          cx="230"
          cy="285"
          r="2"
          fill="rgba(255,255,255,0.4)"
          style={{ animation: 'mojitoBubbleRise5 3.8s ease-in infinite 0.8s' }}
        />
