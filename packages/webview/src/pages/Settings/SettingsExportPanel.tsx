...
export const SettingsExportPanel: React.FC<SettingsExportPanelProps> = ({ onExport, onImport }) => {
        ...
        <CardBody>
          <div className="flex flex-col gap-[var(--sf-space-3)]">
            <div className="flex gap-[var(--sf-space-2)]">
              <Button variant="secondary" size="sm" onClick={handleExport} data-testid="export-btn">
