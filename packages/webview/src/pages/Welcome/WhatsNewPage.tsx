...
export const WHATS_NEW: Readonly<Record<string, readonly Feature[]>> = {
  '1.39.8': [
    {
      category: 'fix',
      titleKey: 'onboarding.whatsNew.fixRound1398',
      descKey: 'onboarding.whatsNew.fixRound1398Desc',
      navigateTo: 'ai',
    },
  ],
  '1.39.7': [
    {
      ...
      titleKey: 'onboarding.whatsNew.aiSonnet1397',
      descKey: 'onboarding.whatsNew.aiSonnet1397Desc',
      navigateTo: 'settings',
    },
    {
      category: 'fix',
      titleKey: 'onboarding.whatsNew.fixRound1397',
      descKey: 'onboarding.whatsNew.fixRound1397Desc',
      navigateTo: 'forge',
    },
  ],
  '1.39.6': [
