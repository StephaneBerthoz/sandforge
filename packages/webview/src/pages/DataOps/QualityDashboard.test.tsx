...
const results: DataQualityScanResult[] = [
  {
    ...
    score: 85,
    rules: [
      { ruleType: 'completeness', fieldApiName: 'Name', passed: 485, failed: 15, passRate: 97, sampleFailures: [] },
      { ruleType: 'uniqueness', fieldApiName: 'Email', passed: 450, failed: 50, passRate: 90, sampleFailures: ['dup@test.com'] },
    ],
  ...
  },
  {
    ...
    score: 65,
    rules: [
      { ruleType: 'format', fieldApiName: 'Phone', passed: 600, failed: 400, passRate: 60, sampleFailures: ['bad-phone'] },
    ],
    timestamp: '2026-01-01T00:00:00Z',
  },
];
