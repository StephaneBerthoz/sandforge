...
const healthyReport: HealthReport = {
  ...
  factors: [
    { name: 'DailyApiRequests', category: 'limits', score: 100, weight: 0.2, status: 'healthy', detail: '20% used (3,000 / 15,000)', recommendation: 'No action needed.', trend: 'stable' },
    { name: 'DataStorageMB', category: 'storage', score: 80, weight: 0.2, status: 'healthy', detail: '60% used (300 / 500)', recommendation: 'No action needed.', trend: 'stable' },
  ],
...
const warningReport: HealthReport = {
  ...
  factors: [
    { name: 'DailyApiRequests', category: 'limits', score: 50, weight: 0.2, status: 'warning', detail: '83% used (12,450 / 15,000)', recommendation: 'Review scheduled batch jobs.', trend: 'degrading' },
    { name: 'DataStorageMB', category: 'storage', score: 20, weight: 0.2, status: 'critical', detail: '93% used (465 / 500)', recommendation: 'Urgent: Consider archiving old records.', trend: 'degrading' },
  ],
  summary: 'Warning: DailyApiRequests, DataStorageMB approaching limits.',
  topRisks: [
    { name: 'DataStorageMB', category: 'storage', score: 20, weight: 0.2, status: 'critical', detail: '93% used', recommendation: 'Urgent: Archive old records.', trend: 'degrading' },
    { name: 'DailyApiRequests', category: 'limits', score: 50, weight: 0.2, status: 'warning', detail: '83% used', recommendation: 'Review batch jobs.', trend: 'degrading' },
  ],
};
