  ...
  return (
    <div className="flex flex-col gap-3" data-testid="compliance-status">
      ...
      <div className="flex items-center gap-2">
        ...
        <span
          className="px-2 py-0.5 text-[10px] font-semibold uppercase rounded-full bg-(--sf-badge-bg) text-(--sf-badge-fg)"
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        <div className="flex flex-col gap-0.5 p-2 rounded-sm bg-(--sf-bg-primary)">
