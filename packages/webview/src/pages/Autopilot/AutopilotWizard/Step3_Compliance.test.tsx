...
describe('Step3_Compliance', () => {
  it('should render without crashing', () => {
    render(
      <Step3Compliance selectedFramework="none" onSelect={vi.fn()} />,
    );
  ...
  it('should call onSelect when framework is clicked', () => {
    ...
    render(
      <Step3Compliance selectedFramework="none" onSelect={onSelect} />,
    );
  ...
  it('should show selected framework as checked', () => {
    render(
      <Step3Compliance selectedFramework="hipaa" onSelect={vi.fn()} />,
    );
