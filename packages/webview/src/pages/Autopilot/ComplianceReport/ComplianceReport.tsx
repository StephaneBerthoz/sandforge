  ...
  return (
    <div className="flex flex-col gap-4 p-4" data-testid="compliance-report">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        <div className="flex flex-col gap-0.5 p-3 rounded-sm bg-(--sf-bg-primary)">
      ...
      {/* Entries table */}
      <div className="rounded-sm border border-(--sf-border) overflow-hidden">
        <table className="w-full text-xs" data-testid="compliance-rules-table">
          <thead>
            <tr className="bg-(--sf-bg-primary) text-left text-text-secondary">
