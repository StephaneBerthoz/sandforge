...
const mockResult: SyncExecutionResult = {
  ...
  status: 'success',
  objectResults: [
    { objectApiName: 'Account', operation: 'upsert', processed: 500, success: 500, failed: 0, skipped: 0, errors: [] },
    { objectApiName: 'Contact', operation: 'upsert', processed: 1200, success: 1195, failed: 5, skipped: 0, errors: ['Some error'] },
  ],
  totalProcessed: 1700,
  totalSuccess: 1695,
  totalFailed: 5,
