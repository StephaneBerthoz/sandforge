...
| `seed.spec.ts`                        | 16    | Drives the pre-v1.9.0 Seed page through the removed navigation sidebar.                                                                                                                                                     |
| `automation.spec.ts`                  | 15    | 5 references to `getByTestId('sidebar')` — the nav tree removed in v1.9.0.                                                                                                                                                  |
